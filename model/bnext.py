...
def conv3x3(in_planes, out_planes, kernel_size = 3, stride=1, groups = 1, dilation = 1):
    ...
    return nn.Conv2d(in_planes, out_planes, kernel_size, (stride, stride),
                     (kernel_size//2, kernel_size//2), (dilation, dilation), groups, False)


def conv1x1(in_planes, out_planes, stride=1):
    """1x1 convolution"""
    return nn.Conv2d(in_planes, out_planes, 1, (stride, stride), (0,0), (1, 1), 1, False)
...
class firstconv3x3(nn.Module):
    def __init__(self, inp, oup, stride):
        ...
        self.conv1 = nn.Conv2d(inp, oup, 3, (stride, stride), (1,1), (1, 1), 1, False)
...
class HardBinaryConv(nn.Module):
    ...
    def forward(self, x):
        ...
        y = F.conv2d(x, binary_weights, None, (self.stride, self.stride), (self.padding, self.padding), (1, 1), self.groups)
